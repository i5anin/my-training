...
export const MUSCLE_INVOLVEMENT: Record<string, MuscleInvolvement> = {
  ...
  'incline-dumbbell-press': { primary: ['chest', 'shoulders'], secondary: ['triceps'] },
  'chest-press-machine': { primary: ['chest'], secondary: ['triceps', 'shoulders'] },
  'cable-crossover': { primary: ['chest'], secondary: ['shoulders'] },
  'dumbbell-fly': { primary: ['chest'], secondary: ['shoulders'] },
  'сведения-рук-бабочка': { primary: ['chest'], secondary: ['shoulders'] },
  'жим-гантелей-30': { primary: ['chest'], secondary: ['shoulders', 'triceps'] },
  'жим-гантелей-горизонтальный': { primary: ['chest'], secondary: ['triceps', 'shoulders'] },
  'электро-хамер': { primary: ['chest'], secondary: ['triceps', 'shoulders'] },
  ...
  'узкий-жим-штанги': { primary: ['triceps', 'chest'], secondary: ['shoulders'] },
  ...
  'жим-хамер-плечи': { primary: ['shoulders'], secondary: ['triceps', 'traps'] },
  'жим-плечи-неразборчиво': { primary: ['shoulders'], secondary: ['triceps'] },
  'дельта-машина': { primary: ['shoulders'], secondary: ['traps'] },
  'lateral-raise': { primary: ['shoulders'], secondary: ['traps'] },
  'cable-lateral-raise': { primary: ['shoulders'], secondary: ['traps'] },
  'отведение-гантелей-сидя-на-скамье': { primary: ['shoulders'], secondary: ['traps'] },
  'отведение-рукояти-в-тренажере-хард': { primary: ['shoulders'], secondary: ['traps'] },
  'подьём-каната-в-кроссовере': {
    primary: ['shoulders'],
    secondary: ['traps', 'rear-delts'],
  },
  'подьём-на-скамье': { primary: ['shoulders'], secondary: ['traps'] },
  'front-raise': { primary: ['shoulders'], secondary: ['chest', 'core'] },
